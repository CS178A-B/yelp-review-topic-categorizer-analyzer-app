...
To run the client side in one terminal, change directories into src -> yelp_analyzer. After that, run `npm install` (if you don't have it already), then run `npm start`.
